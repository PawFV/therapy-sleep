...
const translations = {
  en: {
    ...
    'header.energia_vital.label': 'Renew energy',
    'header.energia_vital.description': 'Gentle vitality when you feel drained or shut down',
    'header.confianza.label': 'Confidence',
    'header.confianza.description': 'Trust yourself to speak, choose, and set limits',
    'header.impulso_autoestima.label': 'Self-esteem boost',
    'header.impulso_autoestima.description': 'Day-to-day recognition without empty positivity',
    'header.preparacion_estres.label': 'Stress prep',
    'header.preparacion_estres.description': 'Before a psychologically heavy situation',
  ...
  es: {
    ...
    'header.energia_vital.label': 'Energía vital',
    'header.energia_vital.description': 'Vitalidad suave cuando estás agotado o apagado',
    'header.confianza.label': 'Confianza',
    'header.confianza.description': 'Confiar en vos para hablar, elegir y marcar límites',
    'header.impulso_autoestima.label': 'Impulso de autoestima',
    'header.impulso_autoestima.description': 'Reconocimiento cotidiano sin positividad vacía',
    'header.preparacion_estres.label': 'Preparación al estrés',
    'header.preparacion_estres.description': 'Antes de una situación psicológicamente pesada',
